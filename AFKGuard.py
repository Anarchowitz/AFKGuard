...
import pyautogui
#НАСТРОЙКИ
TOKEN = "6541858217:AAEnIzjU3ulGVD6qAeoZg821igAtsNp3pas" # <-- Сюда токен из созданого бота @botfather телеграм
YOUR_CHAT_ID = "1177915114" # <-- Сюда чат айди (узнать можно в боте - @chatIDrobot в тг или другим способом.)
